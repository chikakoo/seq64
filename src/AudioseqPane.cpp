    ...
    : seq64(seq64_)
{
    ...
    cbxAction->addItem(TRANS("Chn Reverb"), 20);
    cbxAction->addItem(TRANS("Chn Vibrato Rate"), 21);
    cbxAction->addItem(TRANS("Chn Vibrato Depth"), 22);
    cbxAction->addItem(TRANS("Chn Vibrato Delay"), 23);
    cbxAction->addItem(TRANS("Chn Pitch Bend"), 24);
    cbxAction->addItem(TRANS("Chn Instrument"), 25);
    cbxAction->addItem(TRANS("Chn Transpose"), 26);
...
void AudioseqPane::fillMeaningsBox(String action) {
    ...
    else if (action == "Chn Reverb") {
        cbxMeaning->addItem("Value", cbxMeaning->getNumItems() + 1);
    }
    else if (action == "Chn Vibrato Rate") {
        cbxMeaning->addItem("Value", cbxMeaning->getNumItems() + 1);
    }
    else if (action == "Chn Vibrato Depth") {
        cbxMeaning->addItem("Value", cbxMeaning->getNumItems() + 1);
    }
    else if (action == "Chn Vibrato Delay") {
        cbxMeaning->addItem("Value", cbxMeaning->getNumItems() + 1);
    }
